...
The link to the Ventures deployed frontend can be found [here]() along with the [github repo](https://github.com/whitneyburton/ventures-fe). The link to the deployed Ventures Backend API can be found [here](https://ventures-be.herokuapp.com/api/v1/events) along with the [github repo](https://github.com/mgoodhart5/ventures-be). We used waffle.io for our [agile board](https://waffle.io/whitneyburton/ventures-fe).
